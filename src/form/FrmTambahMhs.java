...
public class FrmTambahMhs extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        String nmMhs = txtNmMhs.getText();
        String jnsKelamin = cmbJnsKelamin.getSelectedItem().toString();
        String almt = txtAlmt.getText();
        String noHp = txtNoHp.getText();
        String semester = txtSemester.getText();
        String jenjang = cmbJenjang.getSelectedItem().toString();
        String thnAkd = txtThnAkd.getText();
        ...
        try {
            String sql = "INSERT INTO mahasiswa(nim,nmMhs,tmptLahir,tglLahir,jnsKelamin,almt,noHp,semester,jenjang,thnAkademik)"
            + "VALUES('"+nim+"', "
            +"'"+nmMhs+"', "
            +"'"+tmptLahir+"', "
            +"'"+tglLahir+"', "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTambahMhs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTambahMhs().setVisible(true);
            }
        });
    }
    ...
    private components.Combobox cmbJenjang;
    private components.Combobox cmbJnsKelamin;
    ...
    private javax.swing.JTextField txtThnAkd;
    private javax.swing.JTextField txtTmptTgl;
